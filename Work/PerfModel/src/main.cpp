...
//     DRAMW<bitset<32>, bitset<64>> * SdMEM = new DRAMW<bitset<32>, bitset<64>>("SdMEM", config->children["SeedMemory"], true);
//     SdMEM->input(ioDir);

//     map<char, DRAMW<bitset<32>, bitset<32>>*> OcMEMs;
//     DRAMW<bitset<32>, bitset<32>> * OccAMEM = new DRAMW<bitset<32>, bitset<32>>("OccAMEM", config->children["OccMemory"], true);
//     OccAMEM->input(ioDir);
//     OcMEMs['A'] = OccAMEM;

//     DRAMW<bitset<32>, bitset<32>> * OccCMEM = new DRAMW<bitset<32>, bitset<32>>("OccCMEM", config->children["OccMemory"], true);
//     OccCMEM->input(ioDir);
//     OcMEMs['C'] = OccCMEM;

//     DRAMW<bitset<32>, bitset<32>> * OccGMEM = new DRAMW<bitset<32>, bitset<32>>("OccGMEM", config->children["OccMemory"], true);
//     OccGMEM->input(ioDir);
//     OcMEMs['G'] = OccGMEM;

//     DRAMW<bitset<32>, bitset<32>> * OccTMEM = new DRAMW<bitset<32>, bitset<32>>("OccTMEM", config->children["OccMemory"], true);
//     OccTMEM->input(ioDir);
//     OcMEMs['T'] = OccTMEM;
...
//     DRAMW<bitset<32>, bitset<64>> * SiMEM = new DRAM<bitset<32>, bitset<64>>("SiMEM_"+confName, config->children["SIMemory"], false);
